import ChatList, { ChatListProps } from '@/components/pro-chat/ChatList';
import isEqual from 'fast-deep-equal';
import { memo, useMemo } from 'react';

import { useStore } from '@/components/pro-chat/ProChat/store';
import { chatSelectors } from '@/components/pro-chat/ProChat/store/selectors';

import { ChatListItemProps } from '@/components/pro-chat/ChatList/ChatListItem';
import useProChatLocale from '@/components/pro-chat/ProChat/hooks/useProChatLocale';
import { useRefFunction } from '@/components/pro-chat/ProChat/hooks/useRefFunction';
