import { DEFAULT_AVATAR, DEFAULT_USER_AVATAR } from '@/components/pro-chat/ProChat/const/meta';
import { ModelConfig } from '@/components/pro-chat/ProChat/types/config';
import { MetaData } from '@/components/pro-chat/ProChat/types/meta';
